...
public class SeedData {
    ...
    public static vott.models.dao.TestResult newTestTestResult(int vehiclePK, int fuelEmissionPK, int testStationPK, int testerPK, int preparerPK, int vehicleClassPK, int testTypePK, int identityPK) {
        ...
        tr.setCreatedAt("2021-01-01 00:00:00.111");
        tr.setLastUpdatedAt("2021-01-01 00:00:00.222");
        tr.setTestCode("111");
        ...
        tr.setTestTypeStartTimestamp("2022-01-01 00:00:00.123");
        tr.setTestTypeEndTimestamp("2022-01-01 00:00:00.456");
